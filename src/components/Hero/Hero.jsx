  ...
  return (
    <>
      <main className="bg-gradient-to-r from-violet-950 to-violet-900 pt-20 dark:bg-violet-950">
        <section
          className="container
          flex h-[650px] flex-col items-center justify-center md:h-[500px]
          "
        >
          <div className="grid grid-cols-1 items-center gap-8 dark:text-white md:grid-cols-2">
            <div
              ...
              data-aos-one={true}
              className="flex flex-col items-center gap-4 text-center text-white md:text-left md:items-start"
            >
