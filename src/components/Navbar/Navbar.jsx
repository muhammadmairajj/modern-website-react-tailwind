...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        <nav className="container h-[70px] flex justify-between items-center py-2">
          {/* LOGO NAME */}
          ...
          <div className="hidden md:block">
            <ul className="flex items-center gap-10">
              <li className="group relative cursor-pointer">
                ...
                <div className="absolute -left-9 z-[999] hidden w-[150px] rounded-md bg-white p-2 text-black group-hover:block">
                  ...
                  <div className="grid grid-cols-3 gap-5 ">
                    ...
                    <div className="col-span-2">
                      ...
                      <p className="text-sm text-slate-600">
                        ...
                        aperiam deleniti
                        <br /> reprehenderit doloribus, numquam corporis quae.
                      </p>
              ...
              <div className="flex item-centers gap-4">
                ...
                <li>
                  <div>
                    ...
                    <p className="text-lg">
                      {" "}
                      <a href="tel:+92123456789">+92 123456789</a>
                    </p>
                  </div>
                </li>
              </div>
